...
(() => {
    ...
    function updateTranscript() {
        ...
        try {
            ...
            const subtitleWrapper = termGradeElement.querySelector(".esg-collapsible-group__title .esg-collapsible-group-subtitle__wrapper");
            console.log("subtitleWrapper:", subtitleWrapper);
            const gpaDiv = subtitleWrapper.querySelector(".esg-collapsible-group__subtitle");
